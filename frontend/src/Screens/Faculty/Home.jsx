...
const Home = () => {
  ...
  const getMenuItemClass = (menuId) => {
    ...
    return `text-center px-6 py-3 cursor-pointer font-medium text-sm rounded-md transition-all duration-300 ease-in-out ${
      isSelected
        ? "bg-blue-500 text-black !important shadow-lg"
